...
class MeetingJoinPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: JoinAppointmentPage(),
    );
  }
}

class JoinAppointmentPage extends StatefulWidget {
  @override
  _JoinAppointmentPageState createState() => _JoinAppointmentPageState();
}

class _JoinAppointmentPageState extends State<JoinAppointmentPage> {
              ...
              children: [
                Row(
                  children: [
                    ...
                    ClipOval(
                      child: Image.asset(
                        'lib/images/profile2.png', // 여기에 이미지 경로를 입력하세요.
                        width: 40,
                        height: 40,
                        fit: BoxFit.cover,
                      ),
                    ...
                    ClipOval(
                      child: Image.asset(
                        'lib/images/profile3.png', // 여기에 이미지 경로를 입력하세요.
                        width: 40,
                        height: 40,
                        fit: BoxFit.cover,
                      ),
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('3/4', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                        Text('모집 인원 현황',
                ...
                SizedBox(height: 16),
                Divider(),
                _buildParticipant('이태화', '참여하고 싶습니다!', 119, 'lib/images/profile1.png'),
                Divider(),
                _buildParticipant('우상현', '참여하고 싶습니다!', 13, 'lib/images/profile2.png'),
                Divider(),
                _buildParticipant('최명은', '참여하고 싶습니다!', 13, 'lib/images/profile3.png'),
                SizedBox(height: 1),
                Divider(),
                Row(
                  children: [
